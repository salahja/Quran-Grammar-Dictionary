...
public class ManageGroup extends Group {
    ...
    public ManageGroup(Context context) {
        super(context);
    }

    public ManageGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ManageGroup(Context context, AttributeSet attrs, int defStyleAttr) {
