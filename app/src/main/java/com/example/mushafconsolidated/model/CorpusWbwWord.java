...
public class CorpusWbwWord {
    ...
    private SpannableStringBuilder corpusSpnnableQuranverse;
    private String quranversestr;
    ...
    public void setQuranversestr(String quranversestr) {
    ...
    public SpannableStringBuilder getCorpusSpnnableQuranverse() {
        return corpusSpnnableQuranverse;
    }

    public void setCorpusSpnnableQuranverse(SpannableStringBuilder corpusSpnnableQuranverse) {
        this.corpusSpnnableQuranverse = corpusSpnnableQuranverse;
    }
