...
public class OrignalFlowAyahWordAdapter extends RecyclerView.Adapter<OrignalFlowAyahWordAdapter.ItemViewAdapter> implements OnItemClickListenerOnLong {
  ...
  public OrignalFlowAyahWordAdapter(ArrayList<String> header, ArrayList<QuranEntity> colorerab, List<QuranEntity> allofQuran,
  ...
  public class ItemViewAdapter extends RecyclerView.ViewHolder implements View.OnClickListener, OnLongClickListener {
    ...
    ItemViewAdapter(View view, int viewType) {
      ...
      if (viewType == 0) {
        ...
        cardview = view.findViewById(R.id.flow_word_by_word);
