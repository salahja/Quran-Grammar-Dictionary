...
public class SifaAdapter extends RecyclerView.Adapter<SifaAdapter.ItemViewAdapter> {
    ...
    private int form;
    private ArrayList<SifaPOJO> list;
    ...
    public SifaAdapter(Context context, ArrayList<SifaPOJO> sifaEntities) {
    ...
    public void onBindViewHolder(@NonNull ItemViewAdapter holder, int position) {
     TextView arabic;
        ...
        final SifaPOJO sifa = list.get(position);
    ...
    public void setUp(ArrayList<SifaPOJO> list, Context context) {
    ...
    public class ItemViewAdapter extends RecyclerView.ViewHolder
        ...
        TextView chapterverse, arabicword, meaning, wazan, gendernumber, cases, nounname, participles, ayah, translation;
        ImageView more;
