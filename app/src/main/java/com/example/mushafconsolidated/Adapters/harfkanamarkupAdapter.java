...
public class harfkanamarkupAdapter extends RecyclerView.Adapter<harfkanamarkupAdapter.AyahViewHolder> implements OnItemClickListener {
    private static final int PERMISSION_REQUEST_CODE = 100;
    private final List<QuranEntity> allofqurans;
    ArrayList<Integer> thisindices;
    ArrayList<Integer> phraseindeces;
    static boolean showTranslation;
    static boolean wordByWord;
    int phraseonenoofword,phrasetwonofofwords;

    public int getPhraseonenoofword() {
        return phraseonenoofword;
    }

    public void setPhraseonenoofword(int phraseonenoofword) {
        this.phraseonenoofword = phraseonenoofword;
    }

    public int getPhrasetwonofofwords() {
        return phrasetwonofofwords;
    }

    public void setPhrasetwonofofwords(int phrasetwonofofwords) {
        this.phrasetwonofofwords = phrasetwonofofwords;
    }
    ...
    public int getIsmphrase() {
        return ismphrase;
    }

    public void setIsmphrase(int ismphrase) {
        this.ismphrase = ismphrase;
    }

    public int getKhabarphrase() {
        return khabarphrase;
    }

    public void setKhabarphrase(int khabarphrase) {
        this.khabarphrase = khabarphrase;
    }
    ...
    public harfkanamarkupAdapter(List<QuranEntity>  allofqurans,
    ...
    @Override
    public harfkanamarkupAdapter.AyahViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        harfkanamarkupAdapter.AyahViewHolder viewHolder = new harfkanamarkupAdapter.AyahViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(harfkanamarkupAdapter.AyahViewHolder holder, int position) {
        //    ArrayList<Integer> windex = new ArrayList<Integer>();
        harfNasbIndex = new HarfNasbIndexArrays();
        harfNasbIndexorig = new HarfNasbIndex();
        QuranEntity entity = allofqurans.get(position);
...
//        surahInfo.append(surahName+".");
    ...
    public void setListener(OnItemClickListener listener) {
        ...
        mItemClickListener = (OnItemClickListenerOnLong) listener;
    }
    ...
    public class AyahViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public final androidx.appcompat.widget.AppCompatEditText quran_textView;
        ...
        public Button   justkanakhabarphrase,justkanaismphrase;
        public Button finalize, doneb, reset, innawithism, kanawithseprateism,kanismwithphrase,kanwithismnokhabar,kanaismwithkhabarprhase;
        TextView setlength;
        ...
        public AyahViewHolder(View view) {
            super(view);
            view.setTag(this);
            justkanakhabarphrase=view.findViewById(R.id.justkanakhabarphrase);
            justkanaismphrase=view.findViewById(R.id.justkanaismphrase);

            kanaismwithkhabarprhase=view.findViewById(R.id.kanaismwithkhabarprhase);
            kanwithismnokhabar=view.findViewById(R.id.kanwithismnokhabar);
            kanismwithphrase=       view.findViewById(R.id.kanaseprateismwithkhabarprase);
            ...
            kanawithseprateism = view.findViewById(R.id.kanaseprateism);
            ...
            kanwithismnokhabar.setOnClickListener(this);
            justkanakhabarphrase.setOnClickListener(this);
            quran_textView.setTextIsSelectable(true);
            quran_textView.setEnabled(true);
            kanawithseprateism.setOnClickListener(this);
            innawithism.setOnClickListener(this);
            kanismwithphrase.setOnClickListener(this);
            justkanaismphrase.setOnClickListener(this);
            ...
            kanaismwithkhabarprhase.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    harfNasbIndexorig.setHarfwordno(windex.get(2));
                    harfNasbIndexorig.setIsmstartword(0);
                    harfNasbIndexorig.setIsmendword(0);

                    if(getPhraselenone()>0){
                        harfNasbIndexorig.setIsmstartword(5);
                        harfNasbIndexorig.setIsmendword(5);
                        harfNasbIndexorig.setFirstism(windex.get(3));
                        harfNasbIndexorig.setFirstimslen(windex.get(3)+windex.get(4));
                        harfNasbIndexorig.setFirstkhabar(windex.get(6) );
                        harfNasbIndexorig.setFirstkhabarlen(windex.get(6) +getPhraselenone());
                        harfNasbIndexorig.setKhabarstartword(windex.get(5));
                        harfNasbIndexorig.setKhabarendword(windex.get(5)+(getPhraseonenoofword()-1));
                    ...
                    newwritefile("kanan", harfNasbIndexArrayListorig);
            ...
            kanwithismnokhabar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    harfNasbIndexorig.setFirstinna(windex.get(0));
                    harfNasbIndexorig.setFirstinnalen(windex.get(0) + windex.get(1));
                    harfNasbIndexorig.setHarfwordno(windex.get(2));
                    harfNasbIndexorig.setIsmstartword(windex.get(5));
                    harfNasbIndexorig.setIsmendword(windex.get(5));
                    harfNasbIndexorig.setFirstism(windex.get(3));
                    harfNasbIndexorig.setFirstimslen(windex.get(3) + windex.get(4));
                    harfNasbIndexorig.setKhabarendword(0 );
                    harfNasbIndexorig.setKhabarendword(0 );
                    harfNasbIndexorig.setSurahid(getSurahid());
                    harfNasbIndexorig.setAyahid(getAyahid());
                    harfNasbIndexArrayListorig.add(harfNasbIndexorig);
            ...
            justkanakhabarphrase.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    windex.size();
                    harfNasbIndexorig.setFirstinna(windex.get(0));
                    ...
                    //   harfNasbIndexorig.setKhabarstartword(windex.get(8));


                        harfNasbIndexorig.setFirstism(0);
                        harfNasbIndexorig.setFirstimslen(0);
                        harfNasbIndexorig.setIsmstartword(0);
                        harfNasbIndexorig.setIsmendword(0);
 ;

                        harfNasbIndexorig.setFirstkhabar(windex.get(3));
                        harfNasbIndexorig.setFirstkhabarlen(windex.get(3) +getPhraselenone());
                        harfNasbIndexorig.setKhabarstartword(windex.get(5) );
                        harfNasbIndexorig.setKhabarendword(windex.get(5)+getPhraseonenoofword());


                    //  else{

                    //  harfNasbIndexorig.setFirstkhabar(windex.get(6));
                    //  harfNasbIndexorig.setFirstkhabarlen(windex.get(6) + windex.get(7) );

                    //  harfNasbIndexorig.setKhabarendword(windex.get(8) );
            ...
            justkanaismphrase.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    windex.size();
                    harfNasbIndexorig.setFirstinna(windex.get(0));
                    ...
                    if(getIsmphrase()>0){
                        harfNasbIndexorig.setFirstism(windex.get(3));
                        harfNasbIndexorig.setFirstimslen(windex.get(3) +getPhraselenone());
                        harfNasbIndexorig.setIsmstartword(windex.get(5));
                        harfNasbIndexorig.setIsmendword(windex.get(5)+(getPhraseonenoofword()-1));
                    ...
                    if(getKhabarphrase()>0){

                        harfNasbIndexorig.setFirstkhabar(windex.get(6));
                        harfNasbIndexorig.setFirstkhabarlen(windex.get(6) +getPhraselentwo());
                        harfNasbIndexorig.setKhabarstartword(windex.get(8) );
                        harfNasbIndexorig.setKhabarendword(windex.get(8)+getPhrasetwonofofwords());
            ...
            kanismwithphrase.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
               windex.size();
                    harfNasbIndexorig.setFirstinna(windex.get(0));
            ...
            innawithism.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (windex.size() == 3){
                       ...
                       harfNasbIndexorig.setFirstinnalen(windex.get(0) + windex.get(1));
                        harfNasbIndexorig.setHarfwordno(windex.get(2));
                        harfNasbIndexorig.setFirstkhabar(0);
                        harfNasbIndexorig.setFirstkhabarlen(0);

                        harfNasbIndexorig.setIsmstartword(0);
                        harfNasbIndexorig.setIsmendword(0);
                        harfNasbIndexorig.setKhabarstartword(0);
                        harfNasbIndexorig.setKhabarendword(0);
                        ...
                        if (getPhraselenone() > 0) {
                            ...
                            harfNasbIndexorig.setFirstkhabarlen(windex.get(6) + getPhraselenone());
                            harfNasbIndexorig.setKhabarstartword(windex.get(8));
                            harfNasbIndexorig.setKhabarendword(windex.get(8)+getPhraseonenoofword()-1);
                            harfNasbIndexorig.setIsmstartword(windex.get(5));
                            harfNasbIndexorig.setIsmendword(windex.get(5));
                            harfNasbIndexorig.setIsmendword(windex.get(5));
                            ...
                            harfNasbIndexorig.setFirstimslen(0);
                            harfNasbIndexorig.setFirstkhabar(windex.get(3));
                                    harfNasbIndexorig.setFirstkhabarlen(windex.get(3) + windex.get(4));
                            harfNasbIndexorig.setKhabarstartword(windex.get(5));

                            harfNasbIndexorig.setKhabarendword(windex.get(5));
                            harfNasbIndexorig.setIsmstartword(0);
                            harfNasbIndexorig.setIsmendword(0);
                        }
                        harfNasbIndexorig.setHarfwordno(windex.get(2));
            ...
            kanawithseprateism.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
              ...
              //          resetArrays();
                    ...
                    if (windex.size() == 8) {
                        ...
                        harfNasbIndexorig.setFirstkhabar(windex.get(6));
                        if(phraseonenoofword>0){
                            harfNasbIndexorig.setFirstkhabar(windex.get(6));
                         //   harfNasbIndexorig.setFirstkhabarlen(windex.get(6) + windex.get(9));
                     ...
                     //   harfNasbIndexorig.setFirstism(windex.get(3));
                      //  harfNasbIndexorig.setFirstimslen(windex.get(3) + windex.get(4));
                        ...
                        harfNasbIndexorig.setFirstkhabarlen(windex.get(3) + windex.get(4));
                        harfNasbIndexorig.setHarfwordno(windex.get(2));
                   //     harfNasbIndexorig.setIsmwordno(windex.get(5));
                        harfNasbIndexorig.setKhabarstartword(windex.get(5));
                        ...
                        if (!windex.isEmpty()) {//size 8 single digit kan with ism
                            harfNasbIndexorig.setFirstinna(windex.get(0));
                            harfNasbIndexorig.setFirstinnalen(windex.get(0) + windex.get(1));
                            harfNasbIndexorig.setFirstism(windex.get(3));
                            harfNasbIndexorig.setFirstimslen(windex.get(3) + windex.get(4));
                    ...
                    if (!windex.isEmpty()) {
                        ...
                        Toast.makeText(context, "null values", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        private void resetArrays() {
            ...
            setPhraselenone(0);
            setPhraselentwo(0);
            setPhraseonenoofword(0);
            setPhrasetwonofofwords(0);
         ...
         filename="newkana";
            ...
            for (HarfNasbIndex arrays : harfNasbIndexArrayListorig) {
                ...
                ss.append(arrays.getSurahid()).append(",").append(arrays.getAyahid()).append(",").append(arrays.getFirstinna()).
                        append(",").append(arrays.getFirstinnalen()).append(",").append(arrays.getFirstkhabar()).append(",").append(arrays.getFirstkhabarlen()).append(",").
                        append(arrays.getFirstism()).append(",").append(arrays.getFirstimslen()).append(",").
                        append(arrays.getHarfwordno()).append(",").append(arrays.getIsmstartword()).append(",").
                        append(arrays.getIsmendword()).append(",").
                        append(arrays.getKhabarstartword()).append(",").
                        append(arrays.getKhabarendword()).append(",").
                        append(0).append(",").append("comment");
