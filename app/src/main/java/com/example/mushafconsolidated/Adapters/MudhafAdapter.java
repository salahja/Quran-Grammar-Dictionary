...
public class MudhafAdapter extends RecyclerView.Adapter<MudhafAdapter.ItemViewAdapter> {
    ...
    private int form;
    private ArrayList<MudhafPOJO> list;
    ...
    public MudhafAdapter(Context context, ArrayList<MudhafPOJO> sifaEntities) {
    ...
    public void setUp(ArrayList<MudhafPOJO> list, Context context) {
