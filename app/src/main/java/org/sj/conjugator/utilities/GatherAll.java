...
public class GatherAll {
  ...
  private static GatherAll instance = new GatherAll();
  ...
  public ArrayList<ArrayList> getMazeedListing(String verbmood, String verbroot) {
    ArrayList<ArrayList> skabeer = buildAugmentedLists(verbmood, verbroot);
    return skabeer;
  }

  public ArrayList<ArrayList> getMujarradParticiple(String verbroot, String unaugmentedFormula) {
    ArrayList<ArrayList> skabeer = buildUnAugmentedParticpleList(verbroot,unaugmentedFormula);
    return skabeer;
  }
  public ArrayList<ArrayList> getMujarradIsmAla(String verbmood, String verbroot, String unaugmentedFormula) {
    ArrayList<ArrayList> skabeer = buildUnAugmentedNounofInstrument(verbmood, verbroot,unaugmentedFormula);
    return skabeer;

  }

  public ArrayList<ArrayList> getMujarradZarf(String verbmood, String verbroot, String unaugmentedFormula) {
    ArrayList<ArrayList> skabeer = buildUnAugmentedNounofTimeAndPlace(verbmood, verbroot,unaugmentedFormula);
    return skabeer;
  }
...
"C" -> "مَفْعَلَة"
    ...
    List<String> zarfmafal = new ArrayList<String>();
    List<String> zarfmafil = new ArrayList<String>();
    List<String> zarfmafalatun = new ArrayList<String>();
...
"C" -> "مَفْعَلَة"
    ...
    if(timeAndPlaces!=null){
      //System.out.printf(timeAndPlaces.get(0).toString());
    }
    TimeAndPlaceConjugator zarfconjugator = TimeAndPlaceConjugator.getInstance();
    TimeAndPlaceModifier zarfmodifier = TimeAndPlaceModifier.getInstance();
    List mafalconjuationlist = zarfconjugator.createNounList(unaugmentedTrilateralRoot, "مَفْعَل");
...
// amr.removeAll(Collections.singleton(null));
    ...
    List  standardInstrumentals = StandardInstrumentalConjugator.getInstance().getAppliedFormulaList(unaugmentedTrilateralRoot);
    TrilateralUnaugmentedNouns nounsObject = new TrilateralUnaugmentedNouns(unaugmentedTrilateralRoot);
    List timeAndPlaces = nounsObject.getTimeAndPlaces();
    /*
    0 = "مِفْعَل"
...
3 = "فَعَّالَة"
    ...
    farray.addAll(finalmifal);
    farray.addAll(finalmifalatun);
...
3 = "فَعَّالَة"
    ...
    List<String> mifalmifaltun = new ArrayList<String>();
    List<String> lmifaal = new ArrayList<String>(mifaal);

    List<String> alamifal = new ArrayList<String>();
    List<String> alamifalatun = new ArrayList<String>();
    List<String> alamifaal = new ArrayList<String>();
...
return skabeer;
  ...
  private ArrayList<ArrayList> buildUnAugmentedParticpleList(String verbroot, String unaugmentedFormula) {
    ...
    List<String> listismfael = new ArrayList<String>();
    List<String> listismmafool = new ArrayList<String>();
  ...
  public ArrayList<ArrayList> getMazeedListing(String verbmood, String verbroot, String augmentedFormula) {
    ...
    ArrayList<ArrayList> skabeer = buildAugmentedLists(verbmood, verbroot,augmentedFormula);
  ...
  private ArrayList<ArrayList> buildUnaugmentedLists(String verbmood, String verbroot ) {
    ...
    } else if (verbmood.equals("jussive")) {
    ...
    } else if (verbmood.equals("emphasized")) {
...
3 = "فَعَّالَة"
    ...
    List<String> listmadhi = new ArrayList<String>();
    List<String> listmadhimajhool = new ArrayList<String>();
    List<String> listmudharay = new ArrayList<String>();
    List<String> listmudharymajhool = new ArrayList<String>();
    List<String> listamr = new ArrayList<String>();
    List<String> listamrnahi = new ArrayList<String>();
    List<String> listismfael = new ArrayList<String>();
    List<String> listismmafool = new ArrayList<String>();
    List<String> listmifal = new ArrayList<String>();
    List<String> listmifalatun = new ArrayList<String>();
    List<String> listlmifaal = new ArrayList<String>();
    List<String> listlzarfmafal = new ArrayList<String>();
    List<String> listlzarfmafil = new ArrayList<String>();
    List<String> listlzarfmafalatun = new ArrayList<String>();
   ...
   // for (Object s : ismMifalMifaltun) {
   //   listmifal.add(s.toString());

   // }

   // for (Object s : ismMifaaal) {
   //   listlmifaal.add(s.toString());
   ...
   // }
    ...
    vdetails.add(listmadhi.get(0).toString());
...
//
    List<String> listmifal = new ArrayList<String>();
    List<String> listmifalatun = new ArrayList<String>();
    List<String> listmifaal = new ArrayList<String>();
    List<String> listlzarfmafal = new ArrayList<String>();
    List<String> listlzarfmafil = new ArrayList<String>();
    List<String> listlzarfmafalatun = new ArrayList<String>();
