...
public class NounFormula5 extends AugmentedTrilateralNoun {
     ...
     */
    public String form() {
        return ArabCharUtil.MEEM+ArabCharUtil.DAMMA+root.getC1()+ArabCharUtil.SKOON+ArabCharUtil.TA+ArabCharUtil.FATHA+root.getC2()+ArabCharUtil.FATHA+root.getC3()+suffix;
    }
}
