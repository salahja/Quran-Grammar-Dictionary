 ...
 * @version 1.0
 */
public class NounFormula8 extends NonStandardInstrumentalNounFormula{
    ...
    public String form() {
        ...
        case 14:
        case 16:
            return root.getC1()+ArabCharUtil.KASRA+root.getC2()+ArabCharUtil.SKOON+root.getC3()+suffix;
        }
        return "";
    }
