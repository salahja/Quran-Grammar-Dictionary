...
public class NounFormula8 extends AugmentedTrilateralNoun {
     ...
     */
    public String form() {
        return ArabCharUtil.MEEM+ArabCharUtil.DAMMA+ArabCharUtil.TA+ArabCharUtil.FATHA+root.getC1()+ArabCharUtil.FATHA+root.getC2()+ArabCharUtil.SHADDA+ArabCharUtil.FATHA+root.getC3()+suffix;
    }
}
